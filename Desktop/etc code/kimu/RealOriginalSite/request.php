...
/* ページ設定 */
$data=$pdo->prepare('Select id from requestboard');
$data->execute([]);
...
$sql=$pdo->prepare('Select * from requestboard order by id DESC LIMIT ?, 5');//LIMIT[시작번호][가져올 갯수]
...
<div class="title">
	<center><h1>申請板</h1></center><!-- このように整列する事もできます。 -->
</div>
<table class="table table-hover">
	...
	<tr>
		...
		<td><a href="request-content.php?id=<?=$id?>"><? echo $datas['title']; ?></a></td>
