...
<?php
//select product
foreach ($pdo->query('select b_boardNum, m.name, o.b_subject, o.b_contents, o.file01, o.b_date, t.t_num from olympicBoards o, member m, board_type t where m.mem_num = o.mem_num and o.t_num = t.t_num and o.t_num = 1') as $row) {
