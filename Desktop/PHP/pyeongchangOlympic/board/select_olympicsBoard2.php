...
$view_total = 4; //한 페이지에 3개 게시글이 보인다.
...
//select product
foreach ($pdo->query("select b_boardNum, id, b_subject, b_contents, password, file01 from olympicBoards o, member m, board_type t where m.mem_num = o.mem_num and o.t_num = t.t_num order by b_boardNum DESC LIMIT $page, $view_total") as $row) {
